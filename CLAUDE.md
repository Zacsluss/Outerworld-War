...
- **`node test/all.js` is the gate before any commit.** 81 suites, ~4 minutes. Green means green. A red
  `rooms` with `EADDRINUSE` is another gate or a stray server on the relay ports (8793-8800, and 8810-8812 for `lobby`), not a fault:
