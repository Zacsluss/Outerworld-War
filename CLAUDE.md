...
- **`node test/all.js` is the gate before any commit.** 88 suites, ~5 minutes. Green means green. A red
  `rooms` with `EADDRINUSE` is another gate or a stray server on the relay ports (8793-8800; 8810-8813 for `lobby`, 8820-8821 for `starts`, 8840 for `spectate`, 8850-8851 for `rematch`, 8860-8863 for `safety`; 8870-8871 is the playtest recorder), not a fault:
