...
const TESTS = [
  ...
  { name: 'onecopy', args: ['onecopy.js'], what: 'ONE COPY OF EACH RULE (SCAN-M18 section B): no number copied out of the place that owns it, and no rule written twice -- the second copy is gone from the source, and what is left is driven to prove it still works' },
