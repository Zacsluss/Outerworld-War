...
G.init({players:[{race:'${r[0]}',human:true},{race:'${r[1]}',human:false}],seed:1}); G.players[0].human=false; G.players[0].ai=new AI(G.players[0],'normal'); G.players[0].ai.debug=true; G.players[1].ai.debug=true;
