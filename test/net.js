...
const server = spawn(process.execPath, [path.join(__dirname, 'serve.js'), String(PORT)], { stdio: ['ignore', 'pipe', 'pipe'], env: Object.assign({}, process.env, { BW_CHEATS: '1', BW_COUNTDOWN: '0', BW_READY: '0', BW_MSG_RATE: '100000' }) });   // BW_MSG_RATE: headless clients simulate as fast as the CPU allows -- net_many peaked at 670 messages in one second against the relay's cap of 300, which is ten times a browser's (test/serve.js, BASIC INTERNET-PLAY SAFETY).   // this file keeps its humans alive with `power overwhelming`; cheats are off in a network game otherwise. BW_COUNTDOWN=0: the 5-4-3-2-1 before a game unlocks is test/rooms.js section 13's, and this suite has no business paying five seconds a game for it
