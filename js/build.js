...
const BUILD = {
  ...
  TUNING: ['TILE', 'TPS', 'FEATURE_ID0', 'FEAT_BLOCKED', 'WRECK_BLOCKED', 'LOWERED_BLOCKED', 'CHURN_SLOW', 'MINE_STRIP',
    ...
    'HALL_PULL', 'ANCHOR_PULL', 'ANCHOR_CAP', 'GUARD_COST', 'BASE_PULL', 'BASE_R', 'SENSOR_NEAR', 'SENSOR_CALM', 'AI_CLOAK_RESERVE', 'CAST_APPROACH', 'G.cell'],
