...
- Balance is tuned by AI-vs-AI runs, not by human ladder play. Terran vs Zerg is 64% [59-69] over 382 decided games, which the harness calls undecided: the interval straddles the 60/40 line rather than sitting outside it. Two M6 bug fixes pulled it in opposite directions — Medics that finally heal are worth +9 points to Terran, a repaired A* closed set is worth -6 — and the net against the previous milestone is not detectable over 366 paired seeds. Protoss vs Zerg 52% and Protoss vs Terran 52% were measured a milestone ago and have not been re-run since the pathfinding fix. See HANDOFF.md.
