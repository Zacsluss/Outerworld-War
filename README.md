...
- Balance is tuned by AI-vs-AI runs, not by human ladder play, and no matchup is currently comfortably inside the 60/40 band: **Terran vs Zerg is 79% [75-83] to Terran (outside), Protoss vs Terran 62% [57-67] and Protoss vs Zerg 63% [58-67] (both undecided -- the interval still crosses the line).** All three were re-measured from scratch after a bug found in M9: Hold Position never checked the weapon cooldown, so any unit holding with a target in range fired 24 times a second. See HANDOFF.md.
